...
spec_type        = ddict_conf.SPEC_TYPE
start_year       = ddict_conf.SPEC_START_YEAR
version          = ddict_conf.SPEC_VERSION
previous_version = ddict_conf.SPEC_PREVIOUS_VERSION

#start_year       = int(os.environ['SPEC_START_YEAR'])
#version          = os.environ['SPEC_VERSION']
#previous_version = os.environ['SPEC_PREVIOUS_VERSION']
...
project = spec_type + ' NMDS'
author = u'Commonwealth of Australia'
...
exclude_patterns = ['ddict.conf', 'scripts/*', 'records/*']
...
..
.. |previous-year| replace:: %(previous_year)s
..
.. |previous-version| replace:: %(previous_version)s
..
.. |current-year-bold| replace:: **%(current_year)s**
..
.. |start-year| replace:: %(start_year)s
..
.. |end-year| replace:: %(end_year)s
..
.. |end-year-bold| replace:: **%(end_year)s**
..
.. |due-year| replace:: %(due_year)s
..
